    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolTab", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpellersTabs", x => x.SpellersId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountRole = table.Column<string>(maxLength: 120, nullable: true),
                    FirstLogIn = table.Column<bool>(nullable: false),
                    DateCreated = table.Column<string>(nullable: false),
                    CreatedBy = table.Column<string>(nullable: false),
                    DateUpdated = table.Column<string>(nullable: true),
                    UpdatedBy = table.Column<string>(nullable: true),
                    SchoolTabId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SchoolTab_SchoolTabId",
                        column: x => x.SchoolTabId,
                        principalTable: "SchoolTab",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpellersVideos", x => x.SpellersId);
                    table.ForeignKey(
                        name: "FK_SpellersVideos_SpellersTabs_SpellersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SchoolTabId",
                table: "AspNetUsers",
                column: "SchoolTabId");
        }
